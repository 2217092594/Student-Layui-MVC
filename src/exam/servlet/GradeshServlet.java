 ...
 */
@WebServlet("/GradeshServlet")
public class GradeshServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GradeshServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("role") == "admin" || session.getAttribute("role") == "teacher"
			...
			request.getRequestDispatcher("/gradeguanli.jsp").forward(request, response);
		} else {
