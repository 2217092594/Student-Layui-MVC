 ...
 */
@WebServlet("/StuinfoshServlet")
public class StuinfoshServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public StuinfoshServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("role") == "admin" || session.getAttribute("role") == "teacher"
			...
			request.getRequestDispatcher("/stuinfoshow.jsp").forward(request, response);
		} else {
