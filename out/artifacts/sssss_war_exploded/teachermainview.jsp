...
if(window!=top){
 ...
 <%
 System.out.println("teachermainview界面获取到的session为"+session.getAttribute("role"));
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree" lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="StuinfoshServlet">管理学生信息</a></dd>
            <dd><a href="GradeshServlet">管理学生成绩</a></dd>
            <dd><a href="StuinfoinServlet">添加学生信息</a></dd>
           
            <dd><a href="GradeinServvlet">添加学生成绩</a></dd>
            <!-- <dd><a href="studentadd.jsp">修改学生成绩</a></dd> -->
